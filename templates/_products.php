              ...
              <input type="hidden" name="item_id" value="<?php echo  $item['item_id']??1?>">
                    <?php
                            if (in_array($item['item_id'], $cart->getCartId($product->getData('cart')) ?? [])){
                                ...
                                echo '<button type="submit" class="btn color-accent-bg font-size-12" name="product_submit">Add to Cart</button>';
                            }
                            ?>
                    </form>
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    ...
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-danger"><span class="font-size-20 text-danger">$<?php echo $item['item_price']?></span><small
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">SR Express<br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-secondary">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small>Sold by <a href="#">SR Electronics </a>(4.5 out of 5 | 18,198 ratings)</small>
                    ...
                    <div class="col-6">
                        ...
                        <div class="color my-3">
                            <div class="d-flex justify-content-between">
                                <h6 class="font-ralewaay">Color:</h6>
                                <div class="m-2 color-accent-bg rounded-circle"><button
                                        class="btn font-size-14"></button></div>
                                <div class="m-2 color-primary-bg rounded-circle"><button
                                        class="btn font-size-14"></button></div>
                                <div class="m-2 color-secondary-bg rounded-circle"><button
                                        class="btn font-size-14"></button></div>
                            </div>
                        </div>
                        <!-- end color -->
