<?php
 ...
 if($_SERVER['REQUEST_METHOD'] == "POST"){
   if(isset($_POST['continue-shopping-submit'])){
 ...
 <!-- top-sales -->
    <section id="top-sales">
      ...
      <div class="d-flex justify-content-between margin-neg">
        <h4 class="font-rubik font-size-20">Continue Shopping</h4>
           ...
           <div class="text-center">
            ...
            <?php
                            if (in_array($item['item_id'], $cart->getCartId($product->getData('cart')) ?? [])){
                                ...
                                echo '<button type="submit" class="btn color-accent-bg font-size-12" name="continue-shopping-submit">Add to Cart</button>';
                            }
                            ?>
            </form>
            </div>
